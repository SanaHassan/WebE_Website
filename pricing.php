...
<h1 class="display-1 "><b> PACKAGES</b></h1>
   <!--      <p>
...
<div class="jumbotron1">
  <br>
      ...
      <h2>PRICE <b>PACKAGES</b></h2>
       <h5>Select your Desired Package</h5> 
...
<div class="card-group offset-1">
  <div class="card container" style="border:none;">
    <img src="silver1.png" class="card-img-top" alt="pricing" style="height: 200px;width:200px;margin-left: 20px;" >
    <div class="card-body">
      <h3 class="card-title">Silver</h3>
      <p class="card-text">      
        <ul>
           <li><i class="far fa-check-circle"></i>
          1 Page Custom Website</li>
          <hr>
           <li><i class="far fa-check-circle"></i>
           WordPress CMS (Theme)</li>
           <hr>
           <li><i class="far fa-check-circle"></i>
           1 Header Slider</li>
           <hr>
          ...
          <li> <i class="far fa-check-circle"></i>
           ...
           <hr>
          <li> <i class="far fa-check-circle"></i>
           Photo Gallery (5 Photos)</li>
           <hr>
          <li> <i class="far fa-times-circle"></i>
          No SEO Friendly</li>
          <hr>
          <li> <i class="far fa-times-circle"></i>
           NO Domain Registration</li>
           <hr>
          <li> <i class="far fa-times-circle"></i>
           NO Web Hosting</li>
           <br>
   ...
   <button type="button" class="btn btn-outline-info"><a href="order.php">Read More</a></button>
    </div>
  </div>
  <div class="card container" style="border:none;">
    <img src="gold.png" class="card-img-top" alt="Pricing" style="height: 200px;width:200px;margin-left: 20px;">
    <div class="card-body">
      <h3 class="card-title">Gold</h3>
      <p class="card-text">        
        <ul>
           <li><i class="far fa-check-circle"></i>
          4-5 Page Custom Website</li>
          <hr>
           <li><i class="far fa-check-circle"></i>
           WordPress CMS (Theme)</li>
           <hr>
          ...
          <li> <i class="far fa-check-circle"></i>
           ...
           <hr>
          <li> <i class="far fa-check-circle"></i>
           Photo Gallery (10 Photos)</li>
           <hr>
          <li> <i class="far fa-check-circle"></i>
           SEO Friendly</li>
           <hr>
          <li> <i class="far fa-check-circle"></i>
           Free Domain Registration</li>
           <hr>
          <li> <i class="far fa-check-circle"></i>
            Web Hosting</li>
            <hr>
  ...
  <div class="card container" style="border:none;">
    <img src="platinium.png" class="card-img-top" alt="Pricing"  style="height: 200px;width:200px;margin-left: 20px;">
    <div class="card-body">
      <h3 class="card-title">Platinium</h3>
      <p class="card-text">        <ul>
           <li><i class="far fa-check-circle"></i>
          15-20 Page Custom Website</li>
          <hr>
           <li><i class="far fa-check-circle"></i>
           Wordpress CMS(Theme)</li>
           <hr>
...
<div class="jumbotron2 jumbotron-fluid">
  <div class="container">
    <h1>With Web E you are all set to launch your new website.<br> 
Are you ready for that?<br><br><button type="button" class="btn btn-success"><b><a href="order.php">Order Now</a></b></button></h1>
